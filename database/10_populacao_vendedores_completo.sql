-- =============================================
-- POPULAÇÃO COMPLETA DAS TABELAS REESTRUTURADAS
-- =============================================
-- Gerado automaticamente em: 2025-10-29 16:19:36
-- 54 vendedores únicos + 77 relacionamentos
...
-- =============================================
-- 3. INSERIR RELACIONAMENTOS VENDEDOR-LOJA (77 registros)
-- =============================================

-- Mauá (48) - 11 vendedores
...
SELECT 'População completa finalizada!' as status;

-- RESUMO:
-- ✅ 54 vendedores únicos inseridos
-- ✅ 77 relacionamentos vendedor-loja inseridos
-- ✅ Todas as 6 lojas contempladas
-- ✅ Estrutura N:N implementada com sucesso